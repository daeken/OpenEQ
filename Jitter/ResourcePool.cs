...
namespace Jitter {
    ...
    /// </summary>
    /// <typeparam name="T">
    ///     The type of the object to cache. The type T must
    ...
    /// </summary>
    /// <typeparam name="T">
    ///     The type of the array of objects to cache. The type T must
    ///     have a parameterless constructor.  Do not specify [].
    /// </typeparam>
