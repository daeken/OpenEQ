...
namespace Jitter {
    ...
    public class ThreadManager {
		...
		readonly int[] xBoxMap = { 1, 3, 4, 5 };

		ManualResetEvent waitHandleA, waitHandleB;
		...
		Thread[] threads;
		int currentTaskIndex, waitingThreadCount;
		...
		static void ThreadSleep(int dueTime) {
#if PORTABLE
		...
		static Thread NewThread(ThreadStart action) {
#if PORTABLE
