...
namespace Jitter.Dynamics {
	...
	internal class ArbiterKeyComparer : IEqualityComparer<ArbiterKey> {
		public bool Equals(ArbiterKey x, ArbiterKey y) => x.body1.Equals(y.body1) && x.body2.Equals(y.body2) ||
    ...
    public class ArbiterMap : IEnumerable {
		static readonly ArbiterKeyComparer arbiterKeyComparer = new ArbiterKeyComparer();

		readonly Dictionary<ArbiterKey, Arbiter> dictionary =
			new Dictionary<ArbiterKey, Arbiter>(2048, arbiterKeyComparer);

		ArbiterKey lookUpKey;

        /// <summary>
        ///     Initializes a new instance of the ArbiterMap class.
        /// </summary>
        public ArbiterMap() => lookUpKey = new ArbiterKey(null, null);
