...
using static OpenEQ.Network.ZoneConstants.Constants;
namespace OpenEQ.Network.ZoneConstants {
	internal static class Constants {
		public static int BUFF_COUNT = 30;
		public static int BANDOLIERS_SIZE = 20;
		public static int MAX_PP_MEMSPELL = 12;
		public static int MAX_PP_SKILL = 100;
		public static int SKILLARRAY_SIZE = 100;
		public static int MAX_PP_DISCIPLINES = 200;
		public static int MAX_PLAYER_TRIBUTES = 5;
		public static int MAX_GROUP_MEMBERS = 6;
		public static int MAX_PP_AA_ARRAY = 300;
		public static int POTIONBELT_SIZE = 5;
		public static int MAX_RECAST_TYPES = 20;
		public static int MAX_PP_SPELLBOOK = 720;
		public static int MAX_PP_LANGUAGE = 25;
		public static int BANDOLIER_ITEM_COUNT = 4;
	}
}
